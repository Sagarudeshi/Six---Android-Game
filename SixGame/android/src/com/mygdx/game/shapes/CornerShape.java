...
public class CornerShape extends BasicShape {

	public CornerShape( World world ) {
		super( world );
		...
		vertices = new float[]{
			...
			Globals.sizeBlock * 0.0f, Globals.sizeBlock * -1.0f,
			Globals.sizeBlock * 0.0f, Globals.sizeBlock * 1.0f,
			Globals.sizeBlock * -1.0f, Globals.sizeBlock * 1.0f,

			Globals.sizeBlock * 0.0f, Globals.sizeBlock * -1.0f,
			Globals.sizeBlock * 1.0f, Globals.sizeBlock * -1.0f,
			Globals.sizeBlock * 1.0f, Globals.sizeBlock * 0.0f,
			Globals.sizeBlock * 0.0f, Globals.sizeBlock * 0.0f,
		};
