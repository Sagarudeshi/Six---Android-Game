...
public class UShape extends BasicShape {

	public UShape( World world ) {
		super( world );

		color.set( Color.YELLOW );

		vertices = new float[]{
			Globals.sizeBlock * -1.5f, Globals.sizeBlock * -1.0f,
			Globals.sizeBlock * -0.5f, Globals.sizeBlock * -1.0f,
			Globals.sizeBlock * -0.5f, Globals.sizeBlock * 1.0f,
			Globals.sizeBlock * -1.5f, Globals.sizeBlock * 1.0f,
			...
			Globals.sizeBlock * -0.5f, Globals.sizeBlock * 0.0f,
			Globals.sizeBlock * 0.5f, Globals.sizeBlock * 0.0f,
			Globals.sizeBlock * 0.5f, Globals.sizeBlock * 1.0f,
			Globals.sizeBlock * -0.5f, Globals.sizeBlock * 1.0f
		};
		...
		PolygonShape shapeCenter = new PolygonShape( );
		shapeCenter.set( vertices, 4 * 2 * 2, 4 * 2 );

		Fixture fixtureCenter = body.createFixture( shapeCenter, Globals.densityDefault );
		fixtureCenter.setFriction( Globals.frictionDefault );
		fixtureCenter.setRestitution( Globals.restitutionDefault );
	...
	public void render( ShapeRenderer renderer ) {
		...
		renderer.rect(
			Globals.sizeBlock * -1.5f, Globals.sizeBlock * -1.0f,
			Globals.sizeBlock * 1.0f, Globals.sizeBlock * 2.0f );
		...
		renderer.line( vertices[ 2 ], vertices[ 3 ], vertices[ 16 ], vertices[ 17 ] );
		renderer.line( vertices[ 16 ], vertices[ 17 ], vertices[ 18 ], vertices[ 19 ] );
		renderer.line( vertices[ 18 ], vertices[ 19 ], vertices[ 8 ], vertices[ 9 ] );

		renderer.line( vertices[ 8 ], vertices[ 9 ], vertices[ 10 ], vertices[ 11 ] );
		renderer.line( vertices[ 10 ], vertices[ 11 ], vertices[ 12 ], vertices[ 13 ] );
		renderer.line( vertices[ 12 ], vertices[ 13 ], vertices[ 6 ], vertices[ 7 ] );
